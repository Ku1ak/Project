<template>
    <v-container fluid fill-height class="home-hero" style="max-height:100vh;">
        <v-layout justify-center align-center column pa-5>
            ...
            <div class="display-1 font-weight-bold white--text text-xc-center">Finally be a ffoodie at home with fresh,chef-prepared meals delivered daily to your door.</div>
        ...
        <style scoped>
            .home-hero {
                backround: url ('http://source.unsplash.com/0BhSKStVtdM');
